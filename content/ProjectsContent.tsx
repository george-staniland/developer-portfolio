export function PhotoPortfolioContent() {
    return (
        <>
            <p>
                A portfolio for my art photography practice. Designed by C-CO Studio, Melbourne.
            </p>
            <h6>Tools Used:</h6>
            <ul>
                <li>Next.js 13</li>
                ...
                <li>MaterialUI</li>
                <li>Automatic deployment to Vercel via Github repo</li>
            </ul>
...
export function LomoOceanContent() {
    return (
        <>
            <p>
                Developed while working at <a href="https://thewebguys.co.nz/" target="_blank">The Web Guys</a>. Utilising NextJs for static page generation, ensures fast loading and great SEO optimisation. Configure with WordPress as a headless CMS.
            </p>
            <h6>Tools Used:</h6>
            <ul>
                <li>Next.js 12</li>
...
export function CapScaffContent() {
    return (
        <>
            <p>
            ...
            <div className="div_pb">
                <a
                    href="https://www.capitalscaffolding.co.nz/"
                    target="_blank"
                >
                    View site
                </a>
...
export function DevSiteContent() {
    return (
        <>
            <p>
